					...
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								...
								<li data-thumb="{{ asset($thumbnailList[0]->thumbnail) }}">
									<div class="thumb-image">
										<img src="{{ asset($thumbnailList[0]->thumbnail) }}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								@endif
								@if( count($thumbnailList) >= 2)
								<li data-thumb="{{ asset($thumbnailList[1]->thumbnail) }}">
									<div class="thumb-image">
										<img src="{{ asset($thumbnailList[1]->thumbnail) }}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								@endif
								@if( count($thumbnailList) >= 3)
								<li data-thumb="{{ asset($thumbnailList[2]->thumbnail) }}">
									<div class="thumb-image">
										<img src="{{ asset($thumbnailList[2]->thumbnail) }}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								@endif
							</ul>
						...
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="{{ asset($product->image) }}">
									<div class="thumb-image">
										<img src="{{ asset($product->image) }}"  data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
							</ul>
							<div class="clearfix"></div>
						</div>
